          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex flex-col gap-2">
              ...
              >
                ...
                />
                <span className="bg-gradient-to-r from-[#B88E2F] via-purple-400 to-blue-400 bg-clip-text text-transparent text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-center block">
            ...
            <div className="flex items-center gap-4">
              <motion.a
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gray-800/50 hover:bg-gray-700/50 border border-gray-700/50 hover:border-[#B88E2F]/50 text-gray-300 hover:text-[#B88E2F] rounded-xl transition-all duration-300 backdrop-blur-sm"
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#B88E2F] to-amber-600 hover:from-[#B88E2F]/90 hover:to-amber-600/90 text-white rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-[#B88E2F]/25"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                initial={{ opacity: 0, y: -20 }}
                animate={{ opacity: 1, y: 0 }}
